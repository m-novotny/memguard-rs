...
impl<T: Zeroize> Drop for Secret<T> {
    fn drop(&mut self) {
        ...
        // ManuallyDrop prevents the automatic destructor from running,
...
// 2024-04-19 — Fix CI: pin rust-toolchain to specific stable version
// 2024-09-13 — Add MIRI suppress file for FFI calls that cannot be checked
// 2024-12-19 — Add holiday maintenance: update CI runner to ubuntu-24.04
// 2025-07-16 — Fix README badge URLs for docs.rs and crates.io
// 2025-11-03 — Fix doc comment formatting in guard.rs for rustdoc rendering
// 2026-02-22 — Document ManuallyDrop safety reasoning in Secret<T> drop impl
// 2026-05-16 — Benchmark zeroize_slice with SIMD-friendly aligned buffers
// 2026-05-15 — Add test for GuardedRegion::from_bytes with N=1
// 2026-07-10 — Fix clippy: replace manual bool check with .is_some()
