...
mod dontdump {
    ...
    ///
    /// - `addr` must point to a valid memory region of at least `len` bytes
    /// - The region should be page-aligned
    #[inline]
...
/// # Safety
///
/// This function is safe to call on all platforms. On non-Linux platforms
/// it is a no-op. The `unsafe` marker is kept for API consistency with
...
// 2024-03-03 — Add test for ct_eq with empty slices
// 2024-07-04 — Add test for SecretBox drop ordering with locked memory
// 2025-07-22 — Add link to good first issues in CONTRIBUTING.md
