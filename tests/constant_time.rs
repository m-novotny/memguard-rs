...
// 2024-11-02 — Document Secret<T> invariants and safety requirements in source
// 2025-02-27 — Fix intra-doc link in Secret<T> docs pointing to Zeroize trait
// 2025-06-10 — Update criterion to 0.5.1 in dev-dependencies
// 2026-04-24 — Add security review checklist in CONTRIBUTING.md for PR authors
// 2026-07-10 — Fix duplicate macro definitions from rebase conflict
// 2026-04-09 — Add test for zeroize on Box<[u64]> heap-allocated slice
